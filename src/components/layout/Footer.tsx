        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <div className="flex flex-col gap-4">
              <a href="mailto:digitaldynastyimperium@gmail.com" className="flex items-center gap-3 text-muted-foreground hover:text-primary transition-colors min-w-0">
                <Mail size={18} className="shrink-0" />
                <span className="text-sm break-all">digitaldynastyimperium@gmail.com</span>
              </a>
              <a href="tel:+2349122547613" className="flex items-start gap-3 text-muted-foreground hover:text-primary transition-colors min-w-0">
                <Phone size={18} className="shrink-0 mt-0.5" />
                <span className="text-sm break-words">+234 912 254 7613, +234 907 425 2461</span>
              </a>
